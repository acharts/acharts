...
achart_legend_102_src_legend_debug = function (exports) {
  ...
  Util.augment(Legend, {
    ...
    _getNextY: function () {
      var _self = this, spacing = _self.get('spacingY'), layout = _self.get('layout'), count = _self._getCount();
      if (layout == 'horizontal') {
        return spacing;
      } else {
    ...
    _getTotalWidth: function () {
      var _self = this, spacing = _self.get('spacingX');
...
acharts_1017_src_seriesgroup_debug = function (exports) {
  var Util = achart_util_110_index_debug, ActivedGroup = achart_actived_102_index_debug.Group, PlotItem = achart_plot_111_index_debug.Item, Legend = achart_legend_102_index_debug, Tooltip = achart_tooltip_104_index_debug, Axis = achart_axis_113_index_debug, Series = achart_series_107_index_debug;
  function min(x, y) {
    return x > y ? y : x;
  }
  function max(x, y) {
